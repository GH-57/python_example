...
# - SQL을 직접 작성하지 않아도 데이터베이스에 대한 조회, 생산, 수정, 삭제 등의 요청을 할 수 있게 된다
#   SQL은 지금은 잘 몰라도, 하면서 이해도를 높이면 보다 효율적인 애플리케이션을 서비스 할 수 있습니다.
#   1) 서비스 개발 비용과 유지 보수 비용 => 개발된 코드를 나/우리가 커버 가능?
#   2) 서버 운영 비용을 낮출 수 있고, 유저에게 보다 빠른 서비스 응답을 줄 수 있다.
